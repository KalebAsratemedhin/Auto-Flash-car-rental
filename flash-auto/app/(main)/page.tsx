...
//   useEffect(() => {
//     // Observe and animate the services as they scroll into view
...
//             }} // Now this arrow function returns void
//             className="flex items-center space-x-6 ml-24 opacity-0 transition-opacity duration-500 ease-in-out"
//           >
    ...
    <div className="flex flex-col bg-gray-100">
      ...
      <div className="space-y-8">
        {services.map((service, index) => (
          <div
            key={index}
            className={`flex items-center space-x-6 ml-24 transform translate-x-16 opacity-0 animate-swoopIn transition-opacity duration-300 ease-out delay-[${index * 100}ms]`}
          >
            <div className="relative flex justify-center items-center w-20 h-20">
              <div className="absolute w-20 h-20 border-4 border-red-600 rounded-full transform rotate-[15deg] border-t-transparent"></div>
              <span className="z-10 text-2xl font-bold text-red-600">{index + 1}</span>
